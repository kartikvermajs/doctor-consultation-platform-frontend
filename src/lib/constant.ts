  ...
  "Ophthalmologist",
   ...
   export const testimonials = [
    ...
    export const faqs = [
    {
      ...
      answer: "With insurance, you pay your copay based on your plan. We accept most plans, including Medicare. Without insurance, online doctor visits are $129. You can become a CuraVault+ member and pay $44/visit. Membership is $55 for three months and $180 for a yearly membership."
    },
    {
